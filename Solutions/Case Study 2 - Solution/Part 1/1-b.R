setwd("/Users/Prateek/Documents/Summer 16/TA/Summer 16/Assignment/Assignment 2/untitled folder/Assignment 2/Part 1/Data/NewData_SampleFormat")
...
which(school_DS$Temperature == -3293.066667)
...
which(is.na(school_DS_kWh_Zero$kWh)) 
unique(school_DS_kWh_Zero)
school_DS_kWh_Zero$kWh <- NULL
head(school_DS_kWh_Zero)
...
school_DS_Reg <- school_DS_kWh_Non_Zero[c("kWh", "month", "hour", "DayOfWeek", "Weekday", "PeakHour")]
dim(school_DS_Reg) 
