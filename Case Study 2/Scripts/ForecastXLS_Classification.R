...
names(forecastInput) <- c("Date", "Hour", "Temp","KWH")

#writing the data to forecastData.csv
filename <- paste("/Users/hpanjwani/R Workspace/Assignment 2/Output/Forecast XLS/forecastOutput_Account_",unique(neural_dataset$Account), "_neuralNetworkClassification.csv", sep = "")
filename;
...
#writing the data to forecastData.csv
filename <- paste("/Users/hpanjwani/R Workspace/Assignment 2/Output/Forecast XLS/forecastOutput_Account_",unique(best_dataset$Account), "_regressionTreeClassification.csv", sep = "")
filename;
write.csv(forecastInput, file=filename)
...
#writing the data to forecastData.csv
filename <- paste("/Users/hpanjwani/R Workspace/Assignment 2/Output/Forecast XLS/forecastOutput_Account_",unique(best_dataset$Account), "_classificationTree.csv", sep = "")
filename;
write.csv(forecastInput, file=filename)